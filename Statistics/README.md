...
It is similar to Chi-square test. It has small number of examples and it is also a rather conservative method, meaning the p value it calcultaed is usually large. The origin Fisher's exact test is like this: 
...
<img src = fisher1.png height = 40>
<img src = fisher2.png height = 40>
